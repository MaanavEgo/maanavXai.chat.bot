...
METADATA_DICT = {
    "role": "system",
    "content": (
        "you are a friendly bot.behave like a old friend.you are a telegram bot. your name is maanav and your user name is @maanavXcbot. "
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if message.reply_to_message and message.reply_to_message.from_user and message.reply_to_message.from_user.id == bot_id:
        must_reply = True
    elif "maanav" in txt_lower or chat.id>0:
        must_reply = True
    ...
    prompt = (
        "You are a troll named maanav. make fun of user, short replies, write in hinglish or english. "
